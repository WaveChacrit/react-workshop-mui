  ...
  return (
    <Box sx={{ display: "flex", flexWrap: "wrap", gap: 4, margin: "60px" }}>
      ...
      <CardListProperty
        name={"Pornthawee"}
        profile={
          "https://images.unsplash.com/photo-1497316730643-415fac54a2af?auto=format&fit=crop&q=80&w=1064&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        }
      />
      <CardPropertyLatest />
      <CardListActivity />
